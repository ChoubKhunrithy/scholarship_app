...
class Homescreens extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        // ß₧Çßƒåß₧Äß₧Åßƒï Font ß₧æß₧╢ßƒåß₧äß₧ÿß₧╝ß₧¢ß₧æßƒàß₧çß₧╢ Kantumruy Pro ß₧¼ Font ß₧üßƒÆß₧ÿßƒéß₧Üß₧òßƒÆß₧ƒßƒüß₧äß₧æßƒÇß₧Å
        ...
        scaffoldBackgroundColor: const Color(0xFF0F1C36), // ß₧ûß₧Äßƒîß₧òßƒÆß₧æßƒâß₧üß₧╢ß₧äß₧ÇßƒÆß₧Üßƒäß₧Ö (Dark Navy)
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                "ß₧ûßƒÉß₧Åßƒîß₧ÿß₧╢ß₧ôß₧òßƒÆß₧æß₧╢ß₧¢ßƒïß₧üßƒÆß₧¢ß₧╜ß₧ô >",
                style: TextStyle(
                  fontSize: 12,
